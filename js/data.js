  ...
  kpis: [
    {
      ...
      decimals: 1,
      goodDirection: "up",
      description: "Andel av befolkningen i arbeidsfør alder (15–64 år) som er i arbeid (AKU/LFS). Norge lå lenge i Europa-toppen, men flere land har tatt oss igjen — Nederland ligger nå klart foran.",
      source: { name: "Eurostat (lfsi_emp_a) / SSB AKU", url: "https://ec.europa.eu/eurostat/databrowser/view/lfsi_emp_a/default/table" },
      series: {
...

    {
      ...
      decimals: 1,
      goodDirection: "down",
      description: "Andel 15–29 år som verken er i arbeid, utdanning eller opplæring (NEET). Et sentralt mål på utenforskap blant unge. Norge ligger lavt i Europa, men har ikke forbedret seg vesentlig på ti år.",
      source: { name: "Eurostat (edat_lfse_20)", url: "https://ec.europa.eu/eurostat/databrowser/view/edat_lfse_20/default/table" },
      series: {
...

    {
      ...
      decimals: 0,
      goodDirection: "down",
      description: "Husholdningenes samlede gjeld i prosent av disponibel inntekt (gjeldsbelastning). Norske husholdninger er blant de mest forgjeldede i verden — gjelden er rundt 2,4 ganger inntekten. Danmark og Nederland har bygget ned, Norge har flatet ut på toppen.",
...

    {
      ...
      description: "Årlig vekst i konsumprisene (KPI for Norge, HICP for de andre landene). Prissjokket i 2022–2023 traff hele Europa; Norge fikk en mindre topp, men inflasjonen har vært tregere ned mot målet på 2 %.",
      source: { name: "Eurostat (prc_hicp_aind) / SSB KPI", url: "https://ec.europa.eu/eurostat/databrowser/view/prc_hicp_aind/default/table" },
      series: {
